...
"map <Leader>t :call FloatTerm()<CR>
...
"map <F6> :call FloatTerm()<CR>
" Open tig, yes TIG, A FLOATING TIGGGG!!!!!!
nnoremap <Leader>ag :call FloatTerm('"tig"')<CR>
map <F7>: call FloatTerm('"tig"')<CR>
...
"vim-lsc java
set shortmess-=F
let g:lsc_server_commands = {'java': 'Library/Containers/com.apple.Home/Data/Downloads/java-language-server-master/dist/lang_server_mac.sh'
